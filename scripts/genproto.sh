...
#<<< "$protobuf_directories"

protoc -I. -I$googleapis_path --grpc-gateway_out=logtostderr=true:. pb/api.proto
protoc -I. -I$googleapis_path --swagger_out=logtostderr=true:. pb/api.proto
